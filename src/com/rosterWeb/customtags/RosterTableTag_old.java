...
public class RosterTableTag_old extends SimpleTagSupport 
{
	...
	protected void genButton(JspWriter out)
	{
	...
	protected void genITORow(JspWriter out,ITO ito)throws JspException, IOException
	{
		...
		float actualWorkingHour=0.0f,thisMonthBalance=0.0f,thisMonthHourTotal=0.0f ,totalHour=(float)noOfWorkingDay*ito.getWorkingHourPerDay(),lastMonthBalance=0.0f;
		String shiftColor,shiftType;
		...
		for (int i=1;i<32;i++)
		{
			...
			if (shiftList.containsKey(i))
			{
				...
				{
					case "b":
					case "b1":shiftColor="b";
							bxShiftCount++;
							break;
					case "d":
					case "d1":
					case "d2":
					case "d3":shiftColor="dx";
							dxShiftCount++;
							break;
					default:
				...
				out.println(getIndentation()+"<td class=\"alignCenter borderCell cursorCell shiftCell "+shiftColor+"ShiftColor\">");
				htmlIndentation++;
	...
	protected void genStatistic(JspWriter out)
	{
	...
	protected void printPrevDateHeaderCell(JspWriter out)throws JspException, IOException 
	{
