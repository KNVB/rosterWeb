...
export default function YearlyRosterStatistic(){
    ...
    Object.keys(contextValue.yearlyRosterStatistic).forEach(itoId=>{
        ...
        let itoMonthlyStatistic=contextValue.yearlyRosterStatistic[itoId].itoMonthlyStatisticList;
        ...
        rowList.push(
            <tr key={itoId+"_subtotal"}>
                <BorderedAlignCenterCell>{contextValue.yearlyRosterStatistic[itoId].itoPostName}</BorderedAlignCenterCell>
