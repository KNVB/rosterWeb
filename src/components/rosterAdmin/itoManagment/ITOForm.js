                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="border border-dark">
                                    <DatePicker
                                        locale="en-ca"
                                        onChange={joinDate => updateTextField({ target: { name: "joinDate", value: joinDate.toLocaleDateString("en-ca") } })}
                                        required={true}
                                        value={ito.joinDate} />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td className="border border-dark">
                                    <DatePicker
                                        locale="en-ca"
                                        onChange={leaveDate => updateTextField({ target: { name: "leaveDate", value: leaveDate.toLocaleDateString("en-ca") } })}
                                        required={true}
                                        value={ito.leaveDate} />
