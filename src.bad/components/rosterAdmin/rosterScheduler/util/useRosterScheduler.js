...
export function useRosterScheduler() {
    ...
    useEffect(() => {
        ...
        let init = async () => {
            try {
                ...
                await itemList.rosterSchedulerDataUtil.init(rosterYear, rosterMonth + 1, itemList.calendarUtility.monthNames[rosterMonth + 1], monthlyCalendar.noOfWorkingDay, monthlyCalendar.calendarDateList.length, itemList.calendarUtility.weekdayNames);
    ...
    let updateRosterMonth = async (newRosterMonth) => {
        ...
        let monthlyCalendar = itemList.calendarUtility.getMonthlyCalendar(rosterYear, rosterMonth);
        await itemList.rosterSchedulerDataUtil.loadData(rosterYear, rosterMonth + 1, itemList.calendarUtility.monthNames[rosterMonth + 1], monthlyCalendar.noOfWorkingDay, monthlyCalendar.calendarDateList.length);
        updateItemList({
            monthlyCalendar,
