...
export default class RosterSchedulerDataUtil {
    constructor() {
        ...
        this.exportRosterDataToExcel = async () => {
            let temp=JSON.parse(JSON.stringify(roster));
            temp.vacantShiftList=JSON.parse(JSON.stringify(rosterSchedulerData.vacantShiftList));
            await fetchAPI.exportRosterDataToExcel(temp);
        }
        ...
        this.init = async (year, month, monthName, noOfWorkingDay, monthLength, weekdayNames) => {
            roster = { activeShiftList: await fetchAPI.getActiveShiftList(), year: year };
            roster.weekdayNames = weekdayNames;
            await this.loadData(year, month, monthName, noOfWorkingDay, monthLength);
        }
        ...
        this.loadData = async (year, month, monthName, noOfWorkingDay, monthLength) => {
